...
#Then below I'm just including each graph within the loop by their name, this allows me to customize where each graph is going 
timeseries = list()
...
#Running and reformatting all statistics for the table
#finding outliers
Outlier <- comb_out %>%
...
# Define the range for the slope so these can be highlighted on the table 
slope_min <- 1.0 - 0.35
slope_max <- 1.0 + 0.35
slopeminO3 <- 1.0 - 0.20
slopemaxO3 <- 1.0 + 0.20
